                        ...
                        <tbody>
                            @forelse($cart_items as $item)
                                <tr wiree:key='{{ $item['product_id'] }}'>
                                    ...
                                    <td class="py-4">{{ 'Rp ' . number_format($item['unit_amount'], 0, ',', '.') }}
                                    </td>
                                    <td class="py-4">
                                        <div class="flex items-center">
                                    ...
                                    <td class="py-4">{{ 'Rp ' . number_format($item['total_amount'], 0, ',', '.') }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-4xl font-semibold text-slate-500">
                                        Tidak ada Product di kernjang</td>
                                </tr>
                            @endforelse
